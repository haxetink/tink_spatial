...
@:jsonParse((array:Array<tink.s2d.Polygon>) -> (cast array : tink.s2d.MultiPolygon))
@:tink.encode(line -> (cast line : Array<tink.s2d.Polygon>))
@:tink.decode((array:Array<tink.s2d.Polygon>) -> (cast array : tink.s2d.MultiPolygon))
@:observable
@:access(tink.s2d)
